...
2. Project Structure
healthcare-bhutan/ │ ├── data/ │ ├── raw/ # Raw datasets (CSV, XLSX, etc.) │ ├── processed/ # Cleaned & transformed data │ ├── notebooks/ │ ├── 01_data_exploration.ipynb │ ├── 02_feature_engineering.ipynb │ ├── 03_modeling.ipynb │ ├── src/ │ ├── data_loader.py │ ├── preprocessing.py │ ├── train_model.py │ ├── utils.py │ ├── app/ │ ├── streamlit_app.py │ ├── models/ │ ├── trained_model.pkl │ ├── README.md ├── requirements.txt └── starter.py
...
All files should be placed in data/raw/. Download data set from https://data.humdata.org/dataset/who-data-for-btn
...
pandas numpy scikit-learn matplotlib seaborn streamlit joblib pyyaml
